...
Odoo 10.0 en el base, PostgreSQL 9.6.1 y Supervisord 3.0
...
```
- Para poder compilar e instalar postgres y otros paquetes
```
...
please change ports:
```
odoo_xmlrpc_port = 9069  (8069 default openerp)
odoo_xmlrpcs_port = 9071 (8071 default openerp)
